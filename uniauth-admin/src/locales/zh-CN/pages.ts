export default {
  ...
  // 配置导出模态框
  "pages.configI18n.export": "导出配置",
  "pages.configI18n.export.title": "导出语言配置",
  "pages.configI18n.export.success": "导出成功",
  "pages.configI18n.export.failed": "导出失败",
  "pages.configI18n.export.appId": "选择应用",
  "pages.configI18n.export.appId.placeholder": "请选择应用",
  "pages.configI18n.export.appId.required": "请选择要导出的应用",
  "pages.configI18n.export.language": "选择导出语言",
  "pages.configI18n.export.language.required": "请选择要导出的语言",
  "pages.configI18n.export.type": "选择导出类型",
  "pages.configI18n.export.type.required": "请选择要导出的类型",
  "pages.configI18n.export.type.tree": "嵌套结构",
  "pages.configI18n.export.type.path": "路径结构",
