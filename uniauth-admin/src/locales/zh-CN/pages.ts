export default {
  ...
  'pages.autoQuotaPoolConfig.cronCyclePlaceholder': '请输入刷新周期的Cron表达式',
  ...
  'pages.autoQuotaPoolConfig.filterGroupPlaceholder': '请输入过滤条件组的JSON格式数据',
  'pages.autoQuotaPoolConfig.upnsCache': 'UPN缓存列表 (JSON)',
  'pages.autoQuotaPoolConfig.upnsCachePlaceholder': '请输入UPN缓存列表的JSON格式数据',
  ...
  'pages.autoQuotaPoolConfig.saveFailedInvalidFilterGroup': '保存失败：过滤条件组格式不正确',
  'pages.autoQuotaPoolConfig.saveFailedInvalidUpnsCache': '保存失败：UPN缓存列表格式不正确',
  'pages.autoQuotaPoolConfig.createSuccess': '创建成功',
  'pages.autoQuotaPoolConfig.saveFailedRuleNameRequired': '保存失败：规则名称为必填项',
  'pages.autoQuotaPoolConfig.saveFailedCronCycleRequired': '保存失败：刷新周期为必填项',
  'pages.autoQuotaPoolConfig.saveFailedRegularQuotaInvalid': '保存失败：定期配额无效',
  'pages.autoQuotaPoolConfig.requestFailed': '请求失败',
  'pages.autoQuotaPoolConfig.saveFailedNetworkError': '保存失败：网络错误，请稍后重试',
  ...
  'pages.modelConfig.clientTypePlaceholder': '请输入客户端类型，如：web, ios, android, server, desktop',
  'pages.modelConfig.discountPlaceholder': '请输入0-1之间的折扣值，如0.9表示9折',
  'pages.modelConfig.servicewaresPlaceholder': '请输入服务项标识，多个用逗号分隔',
  'pages.modelConfig.pricingPlaceholder': '请输入JSON格式的定价配置，例如：{"type": "per_token", "input_price": 0.01, "output_price": 0.03}',
  'pages.modelConfig.clientArgsPlaceholder': '请输入JSON格式的客户端参数，例如：{"temperature": 0.7, "max_tokens": 1024}',
  'pages.modelConfig.requestArgsPlaceholder': '请输入JSON格式的请求参数，例如：{"model": "gpt-4", "stream": true}',
