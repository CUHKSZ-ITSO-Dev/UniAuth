export default {
  ...
  "pages.userList.pagination.total": "共 {total} 条数据",
  ...
  "pages.billingDetail.currentMonthOriginalCost": "本月原始费用",
  "pages.billingDetail.discount": "优惠",
  ...
  "pages.dashboard.serviceOption": "服务类型:",
  "pages.dashboard.productOption": "模型:",
  "pages.dashboard.quotaPoolOption": "配额池:",
  "pages.dashboard.dayOption": "天数:",
  "pages.dashboard.todayTitle": "今日消费统计",
  "pages.dashboard.todaySub": "查看今日消费情况",
  "pages.dashboard.todayCost": "今日总消费",
  "pages.dashboard.todayRate": "消费变化率",
  "pages.dashboard.modelTitle": "模型消费统计",
  "pages.dashboard.modelSub": "查看最近模型消费情况",
  "pages.dashboard.modelDetail": "消费明细",
  "pages.dashboard.totalCost": "总消费金额",
  "pages.dashboard.totalCall": "总调用次数",
  "pages.dashboard.modelTrend": "次数趋势",
  "pages.dashboard.modelDistribution": "调用分布",
  "pages.dashboard.date": "日期",
  "pages.dashboard.product": "模型",
  "pages.dashboard.service": "服务类型",
  "pages.dashboard.quotaPool": "配额池",
  "pages.dashboard.cost": "消费金额",
  "pages.dashboard.call": "调用次数",
  "pages.dashboard.activeTitle": "活跃用户统计",
  "pages.dashboard.activeSub": "查看活跃用户数据",
  "pages.dashboard.activeTotal": "总用户数",
  "pages.dashboard.activeUser": "活跃用户数",
  "pages.dashboard.activeTrend": "活跃用户趋势",
  "pages.dashboard.activeRate": "活跃变化率",
  "pages.dashboard.activeQuery": "查询特定用户",
  "pages.dashboard.activeQueryUpnPlaceholder": "请输入UPN",
  "pages.dashboard.search": "搜索",
  "pages.dashboard.lastActive": "最后活跃时间:",
  // ChatPage
