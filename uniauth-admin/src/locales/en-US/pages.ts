export default {
  ...
  "pages.billingDetail.avgDailyCost": "Average Daily Cost",
  "pages.billingDetail.dailyAverageCost": "Daily Average Cost",
  ...
  "pages.dashboard.serviceOption": "Service:",
  "pages.dashboard.productOption": "Model:",
  "pages.dashboard.quotaPoolOption": "QuotaPool:",
  "pages.dashboard.dayOption": "Days:",
  "pages.dashboard.todayTitle": "Today's Consumption Statistics",
  "pages.dashboard.todaySub": "View today's consumption",
  "pages.dashboard.todayCost": "Today's Total Cost",
  "pages.dashboard.todayRate": "Cost Change Rate",
  "pages.dashboard.modelTitle": "Model Consumption Statistics",
  "pages.dashboard.modelSub": "View recent model consumption",
  "pages.dashboard.modelDetail": "Consumption Details",
  "pages.dashboard.totalCost": "Total Cost",
  "pages.dashboard.totalCall": "Total Calls",
  "pages.dashboard.modelTrend": "Call Trend",
  "pages.dashboard.modelDistribution": "Call Distribution",
  "pages.dashboard.date": "Date",
  "pages.dashboard.product": "Model",
  "pages.dashboard.service": "Service",
  "pages.dashboard.quotaPool": "QuotaPool",
  "pages.dashboard.cost": "Cost",
  "pages.dashboard.call": "Calls",
  "pages.dashboard.activeTitle": "Active User Statistics",
  "pages.dashboard.activeSub": "View active user data",
  "pages.dashboard.activeTotal": "Total Users",
  "pages.dashboard.activeUser": "Active Users",
  "pages.dashboard.activeTrend": "Active User Trend",
  "pages.dashboard.activeRate": "Active User Change Rate",
  "pages.dashboard.activeQuery": "Query Specific User",
  "pages.dashboard.activeQueryUpnPlaceholder": "Please enter UPN",
  "pages.dashboard.search": "Search",
  "pages.dashboard.lastActive": "Last Active Time:",
};
