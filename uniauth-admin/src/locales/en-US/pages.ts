...
export default {
  ...
  'pages.policyList.deleteConfirmTitle': 'Are you sure you want to delete this policy?',
  ...
  'pages.policyList.description': 'Manage system access control policies, configuring rules for users, resources, and actions',
  ...
  'pages.policyList.searchTable.subject.placeholder': 'Enter subject, e.g., alice, user_group',
  ...
  'pages.policyList.searchTable.object.placeholder': 'Enter object, e.g., chat_production, database',
  'pages.policyList.searchTable.action': 'Action',
  'pages.policyList.searchTable.action.placeholder': 'Enter action, e.g., read, write, manage',
  'pages.policyList.searchTable.action.required': 'Please enter an action',
  'pages.policyList.searchTable.effect': 'Effect',
  'pages.policyList.searchTable.effect.placeholder': 'Enter effect, e.g., allow, deny',
