export default {
  ...
  "pages.configI18n.appId": "应用ID",
  "pages.configI18n.appId.placeholder": "请选择应用",
  "pages.configI18n.form.appId": "应用ID",
  "pages.configI18n.form.appId.required": "请输入应用ID",
  "pages.configI18n.form.appId.placeholder": "请输入应用ID",
  "pages.configI18n.uploadModal.title": "批量上传翻译",
  "pages.configI18n.uploadModal.appId": "应用ID",
  "pages.configI18n.uploadModal.appId.required": "请输入应用ID",
  "pages.configI18n.uploadModal.appId.placeholder": "请输入应用ID",
  "pages.configI18n.uploadModal.language": "选择语言",
  "pages.configI18n.uploadModal.language.required": "请选择上传的语言",
  "pages.configI18n.uploadModal.language.placeholder": "请选择要上传的语言",
  "pages.configI18n.uploadModal.language.zhCN": "简体中文 (zh-CN)",
