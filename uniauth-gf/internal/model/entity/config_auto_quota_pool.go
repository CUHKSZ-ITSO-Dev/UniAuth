// =================================================================================
// Code generated and maintained by GoFrame CLI tool. DO NOT EDIT. Created at 2025-09-21 23:58:44
// =================================================================================
...
type ConfigAutoQuotaPool struct {
	...
	FilterGroup     []string        `json:"filterGroup"     orm:"filter_group"      description:"过滤条件组"`        // 过滤条件组
