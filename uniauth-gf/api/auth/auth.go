...
type IAuthV1 interface {
    ...
    AdminCheck(ctx context.Context, req *v1.AdminCheckReq) (res *v1.CheckRes, err error)
    AdminCheckAndExplain(ctx context.Context, req *v1.AdminCheckAndExplainReq) (res *v1.CheckAndExplainRes, err error)
    ...
    AdminGetAllQuotaPools(ctx context.Context, req *v1.AdminGetAllQuotaPoolsReq) (res *v1.GetAllQuotaPoolsRes, err error)
    ...
    AdminGetAvailableModelForQuotaPool(ctx context.Context, req *v1.AdminGetAvailableModelForQuotaPoolReq) (res *v1.GetAvailableModelForQuotaPoolRes, err error)
    UniauthLogin(ctx context.Context, req *v1.UniauthLoginReq) (res *v1.UniauthLoginRes, err error)
    UniauthLogout(ctx context.Context, req *v1.UniauthLogoutReq) (res *v1.UniauthLogoutRes, err error)
}
